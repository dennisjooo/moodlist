    ...
    return (
        <>
            ...
            <button
                ...
                className="lg:hidden p-2 h-9 sm:h-10 rounded-lg text-muted-foreground hover:text-foreground hover:bg-accent/50 transition-all active:scale-95"
                aria-label="Toggle menu"
            >
                <div className={cn('w-5 h-5 transition-transform duration-200', isOpen ? 'rotate-90' : 'rotate-0')}>
                    {isOpen ? (
                        <X className="w-5 h-5" />
                    ) : (
