...
class SpotifyAPIClient:
    ...
    async def get_user_profile(
        self, access_token: str, user_id: Optional[str] = None
    ) -> Dict[str, Any]:
        ...
        if user_id:
            self.logger.debug(
                f"Cache miss for user profile {user_id}, fetching from API"
            )
        else:
    ...
    async def get_user_top_tracks(
        ...
        return await self._get(
            SpotifyEndpoints.USER_TOP_TRACKS, access_token, params=params
        )
    ...
    async def get_user_top_artists(
        ...
        params = {"limit": limit, "time_range": time_range, "offset": offset}
        return await self._get(
            SpotifyEndpoints.USER_TOP_ARTISTS, access_token, params=params
        )
    ...
    async def get_user_playlists(
        ...
        return await self._get(
            SpotifyEndpoints.USER_PLAYLISTS, access_token, params=params
        )
    ...
    async def create_playlist(
        ...
        return await self._post(
            f"/users/{user_id}/playlists", access_token, json=json_data
        )
    ...
    async def add_tracks_to_playlist(
        ...
        return await self._post(
            f"/playlists/{playlist_id}/tracks", access_token, json=json_data
        )
    ...
    async def get_track(self, access_token: str, track_id: str) -> Dict[str, Any]:
        """Get track details.
    ...
    async def get_playlist_tracks(
        self, access_token: str, playlist_id: str, limit: int = 100, offset: int = 0
    ) -> Dict[str, Any]:
        ...
        params = {"limit": limit, "offset": offset}
        return await self._get(
            f"/playlists/{playlist_id}/tracks", access_token, params=params
        )

    async def get_playlist(self, access_token: str, playlist_id: str) -> Dict[str, Any]:
    ...
    async def refresh_token(self, refresh_token: str) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(
                "Token refresh failed", status_code=e.response.status_code, error=str(e)
            )
    ...
    async def _post(
        self, endpoint: str, access_token: str, json: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
            ...
            try:
                ...
                if status_code == 401:
                    ...
                    if retry_after:
                        ...
                        if wait_time > 300:
                            ...
                            raise SpotifyRateLimitError(
                                f"Rate limit exceeded (retry after {wait_time:.0f}s)"
                            )
                    else:
                    ...
                    raise SpotifyAPIException(
                        f"Spotify API error: {status_code}", status_code=status_code
                    )
