...
class SeedBasedGenerator:
    ...
    async def _process_seed_chunks(
        ...
        async def process_chunk_with_delay(
            idx: int, chunk: List[str]
        ) -> List[TrackRecommendation]:
    ...
    async def _process_chunk(
        ...
        track_details_map = {
            detail.get("id"): detail for detail in track_details if detail.get("id")
        }
    ...
    async def _create_recommendation(
        ...
        if track_details:
            duration_from_details = track_details.get(
                "duration_ms"
