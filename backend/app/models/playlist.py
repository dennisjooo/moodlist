...
class Playlist(Base):
    ...
    invocations = relationship(
        "Invocation", back_populates="playlist", cascade="all, delete-orphan"
    )
    ...
    __table_args__ = (
        ...
        Index(
            "ix_playlist_user_status_created",
            "user_id",
            "status",
            "deleted_at",
            "created_at",
        ...
        Index(
            "ix_mood_analysis_data_gin", "mood_analysis_data", postgresql_using="gin"
        ),
        Index(
            "ix_recommendations_data_gin",
        ...
        Index(
            "ix_mood_analysis_primary_emotion",
            func.text("(mood_analysis_data->>'primary_emotion')"),
        ),
        Index(
            "ix_mood_analysis_energy_level",
            func.text("(mood_analysis_data->>'energy_level')"),
        ),
    )
